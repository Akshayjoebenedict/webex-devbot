...
if choice.lower() == 'n':
    ...
    accessToken = "Nzk4NDVkMTMtZWE5Ni00ZGNmLWE5NjYtNmY4M2ZkZGRlYWJjOTNiNWEwZjEtOWIw_PC75_f1a9c66d-3eff-454d-9c51-a4e0afcd770b"
...
while True:
    ...
    if message.find("/") == 0:
        ...
        mapsAPIGetParameters = {
            "location": location,
            "key": "wqb88CqTcVj2JVsdLAbFuUw21NSkCcK7"
        }
        ...
        r = requests.post(webex_messages_api_url,
                          ...
                          headers=HTTPHeaders)
        if not r.status_code == 200:
            raise Exception("Incorrect reply from Webex Teams API. Status code: {}. Text: {}".format(r.status_code,
                                                                                                      r.text))
